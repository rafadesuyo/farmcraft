...
namespace PathCreation
{
    ...
    public class PathCreatorData
    {
        ...
        public void Initialize(bool defaultIs2D)
        {
            if (_bezierPath == null)
            {
                CreateBezier(new Vector3[] { Vector3.left * 2, Vector3.left, Vector3.right, Vector3.right * 2 }, defaultIs2D);
            }
        ...
        public void ResetBezierPath(Vector3[] points, bool defaultIs2D = false)
        {
            CreateBezier(points, defaultIs2D);
        }

        void CreateBezier(Vector3[] points, bool defaultIs2D = false)
        {
            if (_bezierPath != null)
            {
                _bezierPath.OnModified -= BezierPathEdited;
            ...
            _bezierPath = new BezierPath(points, false, space);
