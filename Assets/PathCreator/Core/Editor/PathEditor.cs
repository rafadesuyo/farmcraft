                ...
                if (data.showPathOptions)
                {
                    ...
                    if (GUILayout.Button("Reset Path"))
                    {
                        ...
                        Vector3[] points = new Vector3[] {
                            (Vector3.left * 2) + creator.transform.position,
                            Vector3.left + creator.transform.position,
                            Vector3.right + creator.transform.position,
                            (Vector3.right * 2) + creator.transform.position };
                        data.ResetBezierPath(points, in2DEditorMode);
